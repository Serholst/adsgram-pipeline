...
Bucket B из qualifier-output — подмножество лидов, отфильтрованное
и переданное Orchestrator-ом. Это НЕ полный qualifier-output.json,
...
contracts/enricher-output.json
