...
- **Choosing the Structure** — Product Card (v3, DEFAULT) vs Personalized Pitch (v2).
  Product Card — anti-cold-email формат для volume outreach (без greeting, без "I'm Sergo").
  Personalized Pitch — только по запросу пользователя или при очень сильном сигнале.
- **Product Card body** — Formats, Placements, Stats line с @moslender, Clients, Signature, P.S.
- **Personalized Pitch** — 3 параграфа: Product intro, Personalization + TG question + test period, CTA
- **Forbidden Elements** — список запретов (плейсхолдеры,
  комплименты, AI-фразы, подпись Sergo в теле)
- **Pre-Send Checklist** — зависит от структуры: Product Card checklist
  или Personalized Pitch checklist (оба в SKILL.md)
