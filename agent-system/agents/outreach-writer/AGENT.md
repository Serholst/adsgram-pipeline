...
Отфильтрованные по критериям (все условия одновременно):

- Lead Status = "Verified" или "Partially verified"
- Email заполнен — не пустой И не placeholder `(Apollo has_email)`
- Stage = пустой (ни "Draft", ни "1st letter sent")
- First Contact Date = пустой (лид ещё не обрабатывался)
